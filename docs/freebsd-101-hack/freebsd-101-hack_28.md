...
如果你运行 "`ps`" 命令而没有任何选项，它只会显示**你的**拥有控制终端的进程：
...
最常用的"`ps`"命令是"`ps auwwx`"，它显示所有运行中进程的详细信息，类似于`GNU/Linux`上的"`# ps -ef`"：
...
[ps -- 进程状态](https://www.freebsd.org/cgi/man.cgi?query=ps&sektion=1&manpath=freebsd-release-ports)；

[进程和守护进程](https://www.freebsd.org/doc/handbook/basics-processes.html)；

[在 FreeBSD 中显示所有进程](http://raghukumarc.blogspot.com/2011/11/show-all-processes-in-freebsd.html)。
