...
> 原文：[`freddiehaddad.github.io/fast-track-to-rust/cursor.html`](https://freddiehaddad.github.io/fast-track-to-rust/cursor.html)
...
The [`光标`](https://doc.rust-lang.org/std/io/struct.Cursor.html) ^(1) is used with in-memory buffers to provide [`读取`](https://doc.rust-lang.org/std/io/trait.Read.html) or [`写入`](https://doc.rust-lang.org/std/io/trait.Write.html) functionality. Without digressing too much, the `BufReader` we are using works on objects that implement the [`读取`](https://doc.rust-lang.org/std/io/trait.Read.html) trait. For now, think of a [trait](https://doc.rust-lang.org/book/ch10-02-traits.html) as an interface in object-oriented programming languages, with some differences.
...
1.  A Cursor wraps an in-memory buffer and provides it with a [`Seek`](https://doc.rust-lang.org/std/io/trait.Seek.html) implementation. ↩
