...
> 原文：[`freddiehaddad.github.io/fast-track-to-rust/rustle.html`](https://freddiehaddad.github.io/fast-track-to-rust/rustle.html)

随着我们到达这次旅程的终点，我很高兴向大家展示 rustle 程序的最终版本，它已准备好投入生产使用。要编译发布版本，请确保使用 `cargo build --release`。我希望您和我一样享受这次旅程。非常感谢您完成这门课程。祝您在 Rust 之旅中玩得开心！
...
> 您可以在[这里](https://github.com/freddiehaddad/rustle)找到我们在本课程中共同构建的 rustle 程序的两个版本。
