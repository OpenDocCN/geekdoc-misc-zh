...
> 原文：[https://freddiehaddad.github.io/fast-track-to-rust/attributes.html](https://freddiehaddad.github.io/fast-track-to-rust/attributes.html)

Throughout this course, we've been using [attributes](https://doc.rust-lang.org/reference/attributes.html), but we haven't delved into them yet. Let's briefly discuss the attributes you've encountered and provide some useful resources for further exploration.
...
[The Rust Reference](https://doc.rust-lang.org/reference/) provides an in-depth look at [attributes](https://doc.rust-lang.org/reference/attributes.html), and you are encouraged to explore it for a comprehensive understanding of their uses. Additionally, [Rust By Example](https://doc.rust-lang.org/rust-by-example/) offers extra material and illustrates various [use cases](https://doc.rust-lang.org/rust-by-example/attribute.html).
